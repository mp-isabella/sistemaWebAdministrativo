...
export default function Footer() {
  return (
    <footer className="relative bg-white"> {/* Altura reducida aquí */}
      ...
      <div className="relative z-10 container mx-auto px-6 py-12">
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-24 text-white">
            {/* Enlaces Rápidos */}
            <div>
              <h3 className="text-xl font-bold mb-6" style={{ color: colors.highlight }}>Enlaces Rápidos</h3>
              <ul className="space-y-3">
                <li>
                  <Link href="#inicio" className="text-gray-300 hover:text-white transition-colors duration-300 relative group">
                    Inicio
                    <span className="absolute bottom-0 left-0 w-0 h-0.5 transition-all duration-300 group-hover:w-full" style={{ backgroundColor: colors.highlight }}></span>
                  </Link>
                </li>
                <li>
                  <Link href="#servicios" className="text-gray-300 hover:text-white transition-colors duration-300 relative group">
                    Servicios
                    <span className="absolute bottom-0 left-0 w-0 h-0.5 transition-all duration-300 group-hover:w-full" style={{ backgroundColor: colors.highlight }}></span>
                  </Link>
                </li>
                <li>
                  <Link href="#nosotros" className="text-gray-300 hover:text-white transition-colors duration-300 relative group">
                    Quiénes Somos
                    <span className="absolute bottom-0 left-0 w-0 h-0.5 transition-all duration-300 group-hover:w-full" style={{ backgroundColor: colors.highlight }}></span>
                  </Link>
                </li>
                <li>
                  <Link href="#galeria" className="text-gray-300 hover:text-white transition-colors duration-300 relative group">
                    Galería
                    <span className="absolute bottom-0 left-0 w-0 h-0.5 transition-all duration-300 group-hover:w-full" style={{ backgroundColor: colors.highlight }}></span>
                  </Link>
                </li>
                <li>
                  <Link href="#formulario" className="text-gray-300 hover:text-white transition-colors duration-300 relative group">
                    Cotiza Aquí
                    <span className="absolute bottom-0 left-0 w-0 h-0.5 transition-all duration-300 group-hover:w-full" style={{ backgroundColor: colors.highlight }}></span>
                  </Link>
                </li>
            ...
            {/* Servicios */}
            <div>
              <h3 className="text-xl font-bold mb-6" style={{ color: colors.highlight }}>Servicios</h3>
              <ul className="space-y-3">
                <li>
      ...
      <div className="relative z-10 bg-[#016AAB] mt-12 text-white py-4 px-6 flex flex-col lg:flex-row justify-between items-center rounded-t-3xl shadow-xl">
        ...
        <div className="flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-6">
          <p className="text-sm">© {new Date().getFullYear()} Améstica. Todos los derechos reservados.</p>
          <div className="flex flex-wrap justify-center space-x-6">
            <Link href="#" className="text-sm hover:text-gray-200 transition-colors duration-300">
              Términos y Condiciones
            </Link>
            <Link href="#" className="text-sm hover:text-gray-200 transition-colors duration-300">
              Política de Privacidad
            </Link>
            <Link href="/login" className="text-sm hover:text-gray-200 transition-colors duration-300">
              Acceso Trabajadores
            </Link>
          </div>
        </div>
