...
const About: React.FC = () => {
  const stats: Stat[] = [
    { icon: <Users className="h-8 w-8" />, number: "+500", label: "Clientes Satisfechos", iconColor: colors.highlight },
    { icon: <Award className="h-8 w-8" />, number: "+15", label: "Años de Experiencia", iconColor: colors.strong },
    { icon: <Clock className="h-8 w-8" />, number: "+300", label: "Servicio de Emergencia", iconColor: colors.soft },
    { icon: <Shield className="h-8 w-8" />, number: "100%", label: "Trabajos Garantizados", iconColor: colors.dark },
  ];

  return (
    <section id="nosotros" className="py-24 bg-white relative overflow-hidden">
      <div className="absolute -top-16 -left-16 w-80 h-80 bg-extraLight rounded-full opacity-50" 
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center text-justify">
          <div>
            ...
            <div className="space-y-6 text-lg leading-relaxed font-normal" style={{ color: colors.medium }}>
              <p>Somos una empresa especializada en detección y reparación de fugas de agua, con más de 15 años de experiencia ofreciendo soluciones eficientes, sin dañar estructuras.</p>
            </div>
            <div className="mt-10 space-y-8">
              <div>
                <h3 className="text-2xl font-semibold mb-2" style={{ color: colors.strong }}>Nuestra Misión</h3>
              ...
              <div>
                <h3 className="text-2xl font-semibold mb-2" style={{ color: colors.strong }}>Nuestra Visión</h3>
                <p className="text-lg leading-relaxed font-normal" style={{ color: colors.medium }}>
