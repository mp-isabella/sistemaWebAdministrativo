...
INSERT INTO "new_jobs" ("address", "clientId", "completedAt", "createdAt", "createdById", "description", "endTime", "id", "images", "notes", "priority", "scheduledAt", "serviceId", "signature", "startTime", "startedAt", "status", "technicianId", "title", "updatedAt") SELECT "address", "clientId", "completedAt", "createdAt", "createdById", "description", "endTime", "id", "images", "notes", "priority", "scheduledAt", "serviceId", "signature", "startTime", "startedAt", "status", "technicianId", "title", "updatedAt" FROM "jobs";
DROP TABLE "jobs";
