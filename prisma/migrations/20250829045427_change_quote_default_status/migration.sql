...
INSERT INTO "new_quotes" ("clientAddress", "clientCommune", "clientEmail", "clientId", "clientName", "clientPhone", "clientRegion", "companyId", "createdAt", "createdById", "date", "diagnosis", "id", "notes", "quoteNumber", "serviceType", "status", "subtotal", "tax", "taxRate", "technician", "total", "updatedAt", "validUntil") SELECT "clientAddress", "clientCommune", "clientEmail", "clientId", "clientName", "clientPhone", "clientRegion", "companyId", "createdAt", "createdById", "date", "diagnosis", "id", "notes", "quoteNumber", "serviceType", "status", "subtotal", "tax", "taxRate", "technician", "total", "updatedAt", "validUntil" FROM "quotes";
DROP TABLE "quotes";
