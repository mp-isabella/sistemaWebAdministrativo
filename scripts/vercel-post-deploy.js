...
console.log('🚀 Post-deploy setup para Vercel...');
...
async function setupDatabase() {
    try {
        ...
        const vercelUrl = process.env.VERCEL_URL ? `https://${process.env.VERCEL_URL}` : 'https://sistema-web-administrativo-demo-3c6xqu60r.vercel.app';
...
if (process.env.VERCEL === '1') {
    ...
    console.log('ℹ️ No es Vercel, saltando post-deploy setup');
}
