    ...
    <RoleRedirect allowedRoles={["admin"]}>
      <div className="space-y-6">
        <div>
          ...
          <p className="text-gray-600">Panel avanzado de métricas y análisis del negocio</p>
        </div>
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-gray-600">Panel de estadísticas avanzadas disponible solo para administradores.</p>
          </CardContent>
        </Card>
      </div>
    </RoleRedirect>
