...
export default function BillingPage() {
  ...
  }, [session, fetchClients, fetchInvoices])
  ...
  return (
    <RoleRedirect allowedRoles={["administrador", "secretaria"]}>
      <div className="w-full p-6 space-y-6">
        <div className="flex justify-between items-center">
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Facturación</h1>
            <p className="text-gray-600">
              {userRole === 'administrador' ? 'Gestión completa de facturas y pagos' : 'Gestión de facturas y consultas'}
            </p>
          </div>
          {/* Solo administrador puede crear nuevas facturas */}
